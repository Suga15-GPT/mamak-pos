...
refunded still works. A fresh database runs 015, 016, 017 in that order; one
already on main (015 and 017 applied) runs 016 on its own afterwards, which is
safe because 016 only inserts settings rows.
